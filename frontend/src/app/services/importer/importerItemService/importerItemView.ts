...
import { ImporterItemService       } from "./importerItemService";
...
@Component({
  selector: 'importerItemView',
  templateUrl: './importerItemView.html'
})
export class ImporterItemView implements OnInit
{
  ...
  /*************************** Initialization page ***************************/
  constructor(private router:Router, public config:WebSiteConfig, private itemService:ImporterItemService, private storeHouseService:ImporterStoreHouseService, private accountLocalService:AccountLocalService)
  { }
