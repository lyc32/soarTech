...
export class AccountInfoView implements OnInit
{
  ...
  /*************************** Initialization page ***************************/
  constructor(private router:Router, private config:WebSiteConfig, private accountLocalService:AccountLocalService, private accountInfoService:AccountInfoService)
  {}
  ...
  goBack()
  {
    this.router.navigateByUrl(this.accountLocalService.getHomePageUrl(this.account.role));
  }
