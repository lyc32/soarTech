...
@Entity
@Table(name="item_in_process", indexes = {@Index(columnList = "order_number"), @Index(columnList = "serial_number")})
public class ItemInProcess extends CodeNextEntity
{
    @Id
    ...
    public ItemInProcess()
    {}

    public ItemInProcess(Long id, String itemName, String serialNumber, String orderNumber, String state, Long importerId, String importerName, String importTime, String storeHouse, String position, Float price, Long exporterId, String exporterName, String exportTime, String carrier, String trackNumber)
    {
        this.id           = id;
    ...
    public void initItem(String itemName, String orderNumber, String storeHouse)
    {
        this.state        = ItemState.INITIALIZE;
        ...
        this.exporterName = null;
        this.exportTime   = null;
        this.carrier      = null;
        this.trackNumber  = null;
    }

    public ItemInHistory toItemInHistory(String time)
    {
        ItemInHistory item = new ItemInHistory();
    ...
    public String check()
    {
        ...
        if( !ItemState.INITIALIZE.equals(this.getState()) && (this.getSerialNumber() == null || this.getSerialNumber().equals("")))
        {
